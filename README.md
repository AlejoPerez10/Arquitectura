...
## Elementos Extras
- `middlewares:` Códigos que se ejecutan antes de que el Controlador actúe. Lo usamos principalmente para seguridad, como verificar si un usuario ya inició sesión (authMiddleware.js).

- `services:` Lógica de negocio más compleja que sacamos del Controlador para mantenerlo limpio (authService.js).

- `utils:` Herramientas y funciones que usamos en muchas partes del proyecto (tokenUtils.js).
